...
export default function Page () {
	...
	return (
		<main className='flex flex-col min-h-screen min-w-full bg-slate-900 text-white gap-4'>
            ...
            <div className='overflow-scroll container mx-auto gap-4 flex flex-col item-center'>
                        ...
                        {quiz.questions.map((question: Question, index: number) => {
                            return <div key={question.id} className='mb-4 px-8 py-4 flex flex-col w-full bg-slate-800 rounded-md'>
                                ...
                                {question.answers?.map((answer: Answer) => {
                                    return <div key={answer.id} className='mb-4 w-full bg-slate-600 flex justify-between px-4 py-4 rounded-lg'>
                                    ...
                                    <Dialog.Trigger asChild>
                                        <div>
                                            <button onClick={() => {
                                                ...
                                                setIsDialogAnswerOpen(true)}} className="outline-none px-4 py-2 bg-slate-600 rounded-md uppercase font-bold">Add response</button>
                                        </div>
                                    </Dialog.Trigger>
                                    <Dialog.Portal>
